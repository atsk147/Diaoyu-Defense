...
EntityShip_1 = ig.Entity.extend({
    ...
    sfxBubble: new ig.Sound('media/sound/bubble.ogg'),
    ...
    if (this.health - amount <= 0){
      ...
      //Create explosion with coordinates of center of this entity.
			ig.game.spawnEntity( EntityExplosion, this.pos.x + (this.size.x/2), this.pos.y + -10);
            this.sfxHit.play();
    }
...
EntityWater_droplet = ig.Entity.extend({
    ...
    check: function( EntityIsland ) {
		EntityIsland.receiveDamage( 2, this );
		this.kill();
    },
